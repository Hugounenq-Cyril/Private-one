...
Comme dit précédemment les éléments du corps $\mathbb{F}_{q^{\ell^i}}$ peuvent être représentés comme des éléments de $\mathbb{F}_q[X_i]/\langle Q_i \rangle $, avec $Q_i$ un polynôme irréductible.

\paragraph{Construction de tours quasi-cyclotomique}
On commence donc par construire une extension de corps $\mathbb{K}_0=\mathbb{F}_q[Y_0]/\langle P_0 _rangle$ telle que la classe résiduelle $y_0$ de $Y_0$ soit un résidu non $\ell$ adique de $\mathbb{K}_0$, on note $r$ le degré de $P_0$.
