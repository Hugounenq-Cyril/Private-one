...
Slide histoire de la cryptographie.
\begin{itemize}
\item Chiffrement symétrique (DES [1975])
\item échange de clés Diffie-Hellman [1976]
\item RSA [1977]
\item Cryptographie à l'aide de Courbes Elliptiques [1985]
\end{itemize}
\end{frame}
