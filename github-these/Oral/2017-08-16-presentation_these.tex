...
\item $\ell$ est un nombre permier de Atkin et $h=0$ (il existe un nombre fini de premiers de Atkin tels que $h \neq 0$) 
\end{itemize}
...
%   \item We work on $\mathbb{F}_q$ such that $E[\ell] \subset E(\mathbb{F}_q)$,
	...
	\item Nous travaillons dans des extensions $\ell$-adique de $\mathbb F_q$
        en généralisant les constructions de [De~Feo,~Doliskani, Schost '13], [Doliskani,~Schost '15] que nous avons généralisé et où en particulier nous avons un calcul rapide du Frobenius.
