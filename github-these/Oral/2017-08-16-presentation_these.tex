...
Les isogénies, à l'image des courbes elliptiques, ont de nombreuses applications: 
\begin{itemize}
...
\pause
\item constructions de schémas cryptographique post-quantique: [Rotostev,~Stolbunov~'06], [De~Feo,~Jao,~Pl\^ut~'11].
\end{itemize}
...
\begin{frame}
\frametitle{Classification of elliptic curves}
\begin{prop} [Silverman, '86]
...
\begin{frame}
\frametitle{Volcano and extension field}
