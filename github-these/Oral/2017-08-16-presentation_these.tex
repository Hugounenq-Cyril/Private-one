...
\end{align*}}
\pause 
On peut dès lors définir le problème du logarithme discret sur une courbe elliptique. Soit $G=\langle P \rangle$ l'ensemble des points de la courbe elliptique engendré par $P$ un point de $E$, le problème du logarithme discret est à partir de la connaissance de $[x]P$ et $P$ retrouver $x$.  
\end{frame}
