...
\frametitle{Limitations du cas Elkies}
 \bluebox{Trouver un premier $\ell$ de Elkies}{
  ...
  \item Heuristiquement la moitié des paramètres $\ell$ sont supposés être des premiers de Elkies pour une courbe $E$ fixée.
...
\begin{itemize}
\item Si $\ell$ est un nombre d'Atkin ou de Elkies avec $h=0$ alors on obtient la complexité énoncée;
...
\medskip
\item Détermination à partir de $d_{\pi}$ si $\ell_i$ est un nombre premier d'Atkin ou de Elkies 
\medskip 
