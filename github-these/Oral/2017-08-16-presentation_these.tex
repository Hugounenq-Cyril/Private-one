...
%\coordinate (F) at (4,0);
\coordinate (L) at (0:4);
\coordinate (K) at (30:3.5);
\coordinate (J) at (60:3.1);
\coordinate (I) at (90:3.1);
\coordinate (D) at (120:3.1);
\coordinate (E) at (150:3.5);
\coordinate (G) at (180:4);
\coordinate (H) at (210:3.5);
\coordinate (F) at (240:3.1);
\coordinate (C) at (270:3.1);
\coordinate (B) at (300:3.1);
\coordinate (A) at (330:3.5);
\draw (L)--(A)--(B)--(C)--(F)--(H)--(G)--(E)--(D)--(I)--(J)--(K); \draw (K)--(L);
...
\uncover<2-3>{\item[$\rightarrow$] seulement $\langle [\ell^h]P,[\ell^h]Q \rangle = \color{red}{E[\ell^{k-h}]_{{\lambda}}} \color{black} \oplus \color{blue}{E[\ell^{k-h}]_{{\mu}}}$.}
\end{itemize}
\vspace{-1.0mm}
\begin{columns}
\begin{column}{5cm}
