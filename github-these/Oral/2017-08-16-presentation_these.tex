...
\begin{prop} [Silverman, '86]
Soit $E$ une courbe elliptique définie sur $\mathbb{F}_q$, soit $\pi$ l'endomorphisme de Frobenius. Soit les conditions suivantes équivalentes son vérifiées:
\begin{enumerate}
...
\end{enumerate}
\pause
Soit les conditions suivantes équivalentes son vérifiées:
\begin{enumerate}
...
\begin{figure}[h]
		...
		\node at (0,-8.2) {Atkin case  ($\left( \frac{d_{\pi}}{\ell} \right) = -1$)};
		\draw (A)--(B); 
		\draw (A)--(C);
		\draw (A)--(D);		
		...
		\node at (2.8,-8.2) {$\left( \frac{d_{\pi}}{\ell} \right) = 0$};
		\draw (A)--(B);
		\draw (A)--(C);
		\draw (A)--(D);
		\end{scope}
		...
		\node at (0,-8.2) {Elkies case ($\left( \frac{d_{\pi}}{\ell} \right) = 1$)};
		%\draw[-] (A.center) to[bend right=25] (C.center);
		\draw[-,dashed] (A.center) to[bend left=40] (B.center);
		%\draw[-] (B.center) to[bend left=25] (C.center);
		%\draw[-,dashed] (B.center) to[bend right] (D.center);
...
\\4  & 7 \end{smallmatrix} \right) $};
		...
		%\draw (B) node[fill=white]{$\bmod \ell^{h+2}$};
\end{scope}
\begin{scope}[yshift=0cm,xshift=20.0cm]
		\coordinate (D) at (0,0);
		\coordinate (E) at (-6,-5);
		\coordinate (F) at (6,-5);
		\coordinate (G) at (-4,-11);
...
determined, then the matrix that represents the Frobenius determines uniquely a generator of the
...
\begin{frame}
Faire slide avec tour et volcan à côté.
...
\coordinate (A1) at (-8,0);
		...
		\draw (A2) node[left]{$\mathsf{F}_{1}$};
		\draw (A3) node[left]{$\mathsf{F}_{2}$};
		\draw (A4) node[left]{$\mathsf{F}_{3}$};
...
\begin{scope}[xshift=0cm]
	\begin{scope}[yshift=10cm,xshift=6cm]
		...
		%\draw[line width=2.5pt,red,->] (A.center) to[bend right=20] (C.center);
			...
			\only<1>{
			\draw (CA) node[fill=white]{$\bullet$};
			\draw (CA) node[gray!80]{$\bullet$};
			\draw (CB) node[fill=white]{$\bullet$};
			\draw (CB) node[gray!80]{$\bullet$};}
			\only<2>{
			\draw (CA) node[fill=white]{$\bullet$};
			\draw (CB) node[fill=white]{$\bullet$};}
			\draw (A) node[fill=white]{$\bullet$};
			...
			\only<1-2>{
			\draw (CAA) node[fill=white]{$\bullet$};
			\draw (CAA) node[gray!80]{$\bullet$};
			\draw (CAB) node[fill=white]{$\bullet$};
			\draw (CAB) node[gray!80]{$\bullet$};
			\draw (CBA) node[fill=white]{$\bullet$};
			\draw (CBA) node[gray!80]{$\bullet$};
			\draw (CBB) node[fill=white]{$\bullet$};
			\draw (CBB) node[gray!80]{$\bullet$};}
			\end{scope}
