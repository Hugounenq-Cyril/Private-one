...
\begin{frame}
\frametitle{Marche sur le cratère // Décomposition horizontale}
...
0 & \color{blue} \mu \end{smallmatrix} \right)$.
\end{algorithmic}}
Coût de la diagonalisation: $\tilde{O}(\ell^k)$ A verifier en détail...
...
$\ell$ un nombre premier de Atkin, $\langle P,Q \rangle = E[\ell^k]$, $R' \in 
...
Mettre de la complexité dans cette slide ...
\end{frame}
...
\end{column}
\begin{column}{8cm}
Lier cela aux courbes elliptiques...
...
\begin{frame}
  ...
  \frametitle{Calcul dans Tour d'extensions de corps finis}
