...
Les isogénies séparables de degré $\ell$ sont représentées par des fonctions%!!!!!!!map
...
\begin{defi}
Un endomorphisme d'une courbe elliptique $E$ est une isogénie qui a pour image et codomaine $E$.
\end{defi}

\begin{prop}
L'ensemble des endomorphismes d'une courbe $E$ est noté $\mathrm{End}(E)$, de plus $\left( \mathrm{End}(E),+,\circ \right)$ est un anneau.
\end{prop}
...
Nous notons par $\mathcal{O}$ (resp. $\mathcal{O}'$) l'anneau d'endomorphisme de $E$ (resp. $E'$)
\vspace{-4mm}
\begin{columns}
\begin{column}{6cm}
...
Sous-groupe de taille $\ell$  & $\Leftrightarrow$ &     $\ell$-isogénie \pause \\[2mm]
    ...
    Sous-groupe de taille $\ell$ stable par $\pi$   & $\Leftrightarrow$ & $\ell$-isogénie rationnelle 
    \end{tabular}
  \end{center}
...
\begin{center}
  \begin{tabular}{p{13em}p{2em}p{13em}}
     \raggedright Deux espaces propres dans $E[\ell]$
