...
\end{figure}
%\pause
\only<4>{Parler du nombre de matrices à classes de conjugaison près... en fait c'est le nombre d'éléments inversibles dans .... donc $\ell^{k-h-1}$ ?
}
\end{frame}
