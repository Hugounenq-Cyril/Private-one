...
\begin{prop}
Soit $\ell$ un nombre premier de Atkin soient $P,Q,R$ trois points de $E$ 
située sur un volcan de hauteur $0$ tels que $\langle P,Q \rangle = \langle P,R 
...
\item Calcul et test d'un candidat à l'aide d'un polynôme d'interpolation \\
   $L$ qui envoie $P\mapsto S'$ et $Q\mapsto R'$; \hfill $\color{blue!50!gray}{\tilde{O}(r \ell^{O(1)})}$
  \end{enumerate}
...
%	\item Les points de torsion ne sont pas en général définis dans $\mathbb{F}_q$.	
	\item Nous travaillons dans des extensions $\ell$-adiques de $\mathbb F_q$
		...
		\begin{itemize}  
         ...
         \item un calcul rapide du Frobenius,
         \item un calcul rapide du polynôme d'interpolation
         \end{itemize}
...
\item Estimer le coût de calcul de l'anneau des endomorphismes en modifiant l'algorithme de Kohel'96  avec l'étude de l'action de l'endomorphisme du Frobenius et l'implanter.
