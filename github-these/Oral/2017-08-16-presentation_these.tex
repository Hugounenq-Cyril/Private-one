...
%\hfill
%\includegraphics[height=10mm]{Images/Logo_Ecole polytechnique_horizontal_72dpi.jpg} 
\hfill
...
\end{center}
\vspace{-4mm}
Des algorithmes pour déterminer des isogénies horizontales ont déjà été proposés: [Fouquet, Morain, '02], [Ionica,Joux, '10].
\end{frame}
