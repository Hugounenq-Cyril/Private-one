...
\begin{frame}
\frametitle{Définition d'une tour d'extension de corps finis}
\begin{columns}
\begin{column}{2cm}
\begin{center}
\begin{figure}
...
caractéristique de $\mathbb{F}_q$, une tour d'extensions $\ell$-adiques de 
$\mathbb{F}_q$ est une suite d'extensions: $\mathbb{F}_q, \mathsf{F}_{1}, 
\mathsf{F}_{2}, \mathsf{F}_{3}, \cdots$ telles que:
$E[\ell^i] \subset E(\mathsf{F}_{i})$
\begin{itemize}
...
%	\item Les points de torsion ne sont pas en général définis dans $\mathbb{F}_q$.	
	\item Nous travaillons dans des tours d'extensions $\ell$-adiques de $\mathbb F_q$
        en généralisant les constructions de [De~Feo,~Doliskani, Schost '13], 
