...
%\hfill $\tilde{O}(r)$
  ...
  \item Si $F$ définit une isogénie de degré $r$, on la retourne et on termine
   l'algorithme. \hfill $\color{blue!50!gray}{\tilde{O}(r)}$
  \end{enumerate}
\end{enumerate}
...
\hfill\only<2>{$\color{blue!50!gray}{\tilde{O}(r)}$}
  \item Si $F$ définit une isogénie de degré $r$, on la retourne et on termine
   l'algorithme. \hfill\only<2>{$\color{blue!50!gray}{\tilde{O}(r)}$}
  \end{enumerate}
\end{enumerate}
\end{frame}
...
\medskip
\item Calcul de $\langle \red P , \blu Q \rangle = \color{red}{E[\ell^k]_{{\lambda}}} \color{black} \oplus \color{blue}{E[\ell^k]_{{\mu}}} $\\
 et $\langle \color{red} P' \color{black}, \color{blue} Q'\color{black} \rangle = \color{red}{E'[\ell^k]_{{\lambda}}} \color{black} \oplus \color{blue}{E'[\ell^k]_{{\mu}}} $ générateurs de $\ell^k$-isogénies horizontales de directions $\color{red} \lambda \color{black}, \color{blue} \mu$. \hfill\only<2>{$\color{blue!50!gray}{\tilde{O}(r \ell^{O(1)})}$}  
...
%\item Deduce $\to$ $\langle{\color{red}P},{\color{blue}Q}\rangle=E[\ell^k]$ and $\langle{\color{red}P'},{\color{blue}Q'}\rangle=E'[\ell^k]$;
\medskip
\item Calcul de la matrice $\pi(P,Q)$; \hfill\only<2>{$\color{blue!50!gray}{\tilde{O}(\sqrt{r}\ell^{O(1)})}$}
\medskip
