...
\end{prop}
\textbf{Rappel:} L'anneau d'endomorphisme d'une courbe elliptique ordinaire est isomorphe à un ordre dans un corps de nombre quadratique imaginaire.
\end{frame}
...
\draw (AB) node[above,left,text width=2cm]{
$
...
\end{itemize}
%On peut trouver un tel premier dans un intervalle $[1,O(\log(q))]$.
