...
[Bostan,~Morain,~Salvy,~Schost~'08], [Lercier,~Sirvent~'08], [Lairez,~Vaccon~'16] fonctionne en $\tilde{O}(r)$ opérations dans $\mathbb{F}_q$, pour tout $p$. Spécifique au contexte SEA.
\pause
