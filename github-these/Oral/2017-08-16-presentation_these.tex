...
\item[$\rightarrow$] seulement $\langle [\ell^h]P,[\ell^h]Q \rangle = \color{red}{E[\ell^{k-h}]_{{\lambda}}} \color{black} \oplus \color{blue}{E[\ell^{k-h}]_{{\mu}}}$.
\end{itemize}
\vspace{-1.0mm}
\begin{columns}
\begin{column}{5cm}
...
\end{columns}
\begin{itemize}
\item Notre algorithme a une complexité de $\tilde{O}(\ell^{2k+O(1)})$;
