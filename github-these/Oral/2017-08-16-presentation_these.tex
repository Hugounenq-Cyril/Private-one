...
\begin{defi}
Soit $\mathbb{K}$ un corps de caractéristique différente de $2$ et $3$, une courbe elliptique $E$ peut être définie comme 
la variété projective associée à l'équation
\begin{equation}
\label{eq:weierstrass-proj}
E:Y^2=X^3+a_4X+a_6
\end{equation}
avec $a_4,a_6$ des éléments de $\overline{\mathbb{K}}$. Le \emph{point à l'infini} est noté $0_E$. Dès lors 
que $a_4,a_6$ appartiennent à $\mathbb{K}$ alors la courbe est dite
...
\begin{rem}
Par souci de simplicité on va utiliser la représentation affine des points de
la courbe solution de son équation, qui sera elle donnée sous forme de 
Weierstrass simplifiée lorsque la caractéristique du corps est différente de $2$ et de $3$
\begin{equation}
E:Y^2=X^3+AX+B
\end{equation}
avec $A,B$ des éléments de $\overline{\mathbb{K}}$.
\end{rem}
...
\begin{frame}
Parler du logarithme discret sur les courbes elliptiques.
\end{frame}
