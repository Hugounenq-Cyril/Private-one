...
\bluebox{Problème du calcul de l'isogénie explicite}
{
 ...
 \`A partir de $E$, $E'$  deux courbes elliptiques $r$-isogènes définies sur $\mathbb{F}_q$,
...
Nous notons par $\mathcal{O}$ (resp. $\mathcal{O}'$) l'anneau des endomorphismes de $E$ (resp. $E'$)
\vspace{-4mm}
\begin{columns}
\begin{column}{6cm}
...
\begin{frame}
  ...
  \begin{uncoverenv}<3->
    ...
    \item SEA literature appelle cela un \emph{cycle d'isogénies} [Couveignes, Morain '94].%!!!!!!!!!!!!!!!!!!!!
    \end{itemize}
  \end{uncoverenv}
...
\bluebox{Vers un algorithme de Couveignes $\ell$-adic ($\ell$ un premier de Elkies)}{
\begin{algorithmic}[1]
\REQUIRE $E, E'$ deux courbes $r$-isogènes sur $\mathbb{F}_{q}$ 
