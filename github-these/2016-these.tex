...
On a donc bien une correspondance entre les points définis à l'aide du Théorème
 ...
 qui contient tous les éléments $\mathsf{F}_{(i,k_i)}$ des tours d'extension
 $\ell_i$-adiques.
\begin{prop}\todo{définir a un endroit ce qu'est un représentant pour l'orbite du Frobenius}
\label{pro:rep:com}
...
$\mathsf{Gal}(\mathsf{F}_{(i,k_i)}:\mathbb{F}_q)$ sur $P_i$ soit de taille
 maximale:$d_i\ell_i^{o_i}$.  Alors l'orbite de $P$ selon l'action de 
 $\mathsf{Gal}(\mathbb{K}_n:\mathbb{F}_q)$ est elle aussi de taille maximale:
 $\prod_{i=1}^nd_i\ell_i^{o_i}$.
\end{prop} 
...
$\mathsf{Gal}(\overset{n}{\underset{j \neq i_0}{\underset{j = 1}{\otimes}}}\mathsf{F}_{(j,k_j)}\otimes \mathsf{F}_{(i_0,1)}:\overset{n}{\underset{j \neq i_0}{\underset{j = 1}{\otimes}}}\mathsf{F}_{(j,k_j)})$ 
...
l'action d'un élément générateur de 
$\mathsf{Gal}(\overset{n}{\underset{j \neq i_0}{\underset{j = 1}{\otimes}}}\mathsf{F}_{(j,k_j)}\otimes \mathsf{F}_{(i_0,1)}:\overset{n}{\underset{j \neq i_0}{\underset{j = 1}{\otimes}}}\mathsf{F}_{(j,k_j)})$
...
tels que tous les choix possibles de représentants $P_i=[\overset{n}{\underset{j \neq i}{\underset{j = 0}{\prod}}}\ell_j^{k_j}]P_j$
 aiént été effectué. Ainsi le nombre de représentants est
...
\end{algorithm}
 ...
 Cependant il nous reste à voir dans quelle mesure la représentation
