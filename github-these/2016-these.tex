...
\begin{rem}
Pour savoir le coût des algorithmes dépendant de la profondeur de la courbe dans le volcan de $\ell$-iogénies régulier appliqué à une courbe sur un volcan non-régulier il faut prendre en compte le nombre de niveaux en dessous du premier niveau de stabilité de la courbe 
\end{rem}
