...
Ces travaux s'inspirent de ceux de mon mémoire.
...
\begin{proof}
Comme vu précédemment \todo{préciser les références} toute $\ell^i$-isogénie 
engendrée par $R'$ est déterminée par la valeur de $\ell^{h}b^{-1}y^{-1}*$, on 
rappelle de plus que l'on est obligé d'avoir $*y \wedge \ell =1$ pour avoir une
$\ell^{h+i}$-isogénie descendante. 
...
fixé ne donne aucune information sur la $\ell^{i}$-isogénie engendrée par 
$\ell^{h}R$.
