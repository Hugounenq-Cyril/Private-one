...
\todo{Faire un dessin à nouveau !}
 ...
 explications on va se concentrer sur la détermination de représentants d'un  unique point et non d'un couple de points. 
 ...
 sur $Q=[\ell_1^{k_1}]P$ un point d'ordre $\prod_{i=1}^{n-1}\ell_i^{k_i}$ défini 
 sur $\mathsf{F}_{\prod_{j=1}^{n-1}\ell_j^{k_j}})$ et sur 
 $P_n=[\prod_{j=1}^{n-1}\ell_j^{k_j}]P$ un point d'ordre $\ell_1^{k_1}$ défini 
 sur $\mathsf{F}_{\ell_1^{k_1}}$. L'action de 
 $\mathsf{Gal}(\mathsf{F}_{\prod_{j=1}^{n}\ell_j^{k_j}}:\mathsf{F}_{\prod_{j=1}^{n-1}\ell_j^{k_j}})$ 
 est triviale sur $Q$ car celui-ci est défini sur 
 $\mathsf{F}_{\prod_{j=1}^{n-1}\ell_j^{k_j}}$.  L'action de 
 $\mathsf{Gal}(\mathsf{F}_{\prod_{j=1}^{n}\ell_j^{k_j}}:\mathsf{F}_{\prod_{j=1}^{n-1}\ell_j^{k_j}})$
 sur $P_n$ est quant à elle d'ordre $\ell_n^{k_n}$ et donc équivalente à 
 ...
 à l'aide du théorème des restes chinois pour chaque représentant de $P_n$.
