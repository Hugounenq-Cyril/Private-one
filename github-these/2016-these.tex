...
Enfin nous présentons dans le chapitre 7 des variantes de l'algorithme de 
...
volcan. Ainsi en se plaçant dans le même contexte que \cite{BissonSutherLand2009},
où l'on connaît déjà une factorisation de $d_{\pi}$, avec les 
propositions ~\ref{pro:mat:fro} et \ref{pro:mat:fro:atk} on connaîtrait le 
conducteur de la courbe par rapport à $\mathbb{Z}[\pi]$ et donc on pourrait
déterminer l'anneau d'endomorphisme de la courbe.

Dans les travaux similaire à \cite{BissonSutherLand2009} \todo{reformuler cela} pour le calcul 
d'anneau d'endomorphisme tels que \cite{BLS12} pour le calcul de polynôme 
modulaire ou le calcul de polynôme de Hilbert \cite{Broker08} \cite{Sutherland11a} sont utilisés des marches sur le
...
approche est trés raisonnable. De plus comme dit dans le calcul d'isogénies 
...
vraisemblablement pas d'impact sur ces méthodes. Cependant comme dit dans 
