...
elliptique est ordinaire. Ceci peut permettre par exemple dans le cas Elkies (défini 
plus bas) de savoir rester sur le cratère cyclique et, par exemple, de calculer
le nombre de classe d'idéaux \todo{classes de qui?} en parcourant le cratère d'un volcan des $\ell$-isogénies. Cela peut permettre aussi d'atteindre et 
...
\todo{cas du ordinaire à mettre partout ? @Luca Non il suffit de le mettre au début}
\begin{defi}
\label{def:cas:elk}
