...
Frobenius. On se place tout d'abord dans un cas particulier le cas Elkies que 
l'on définit de suite: 
...
On note $h=v_{\ell}(\lambda - \mu)$, ainsi le polynôme caractéristique de $\pi$ admet deux valeurs propres distinctes modulo la $\ell^k$ torsion avec $k \geqslant h$,
