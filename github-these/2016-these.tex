...
\end{equation*}
En particulier on a $\varphi(0_{E_1})=0_{E_2}$.
\end{defi}
...
\begin{rem}
On peut calculer l'isogénie à l'aide de la connaissance de son noyau. Une méthode pratique reste celle préconisé par Elkies \cite{elkies1998} \todo{ref a mettre Kohel???} qui utilise les équations \eqref{eq:velu:gh} et \eqref{eq:velu:sum}:
\begin{equation*}
