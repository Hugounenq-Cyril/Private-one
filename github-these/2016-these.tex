...
$E[\ell^{h-e+i}]=\langle P,Q \rangle$.
Alors la matrice 
\[
\pi(P,[x]P+[y]Q)=\left ( \begin{matrix}a & b\ell^{h-e} \\ c\ell^{h-e} & d
\end{matrix}\right ) 
\] représentant l'action du Frobenius dans la base $\langle P,Q \rangle$ est 
conjuguée aux matrices de la forme:
\[
\pi(P,Q')=\left ( \begin{matrix}a & b\ell^{h-e}\beta \\ c\ell^{h-e}\beta & d
\end{matrix}\right ) 
\]
avec $Q'=[\beta x]P+[\beta y]Q$, $\beta \in \left( \mathbb{Z}/\ell^{i} \mathbb{Z} 
\right)^{\times}$. De plus tous les points qui forment des matrices 
...
$y,y' \wedge \ell=1$, car seulement dans ce cas $R$ et $R'$ formenet avec $P$ 
une base de la $\ell^{h-e+i}$ torsion, $R$ et $R'$ engendrent la même 
$\ell^i$-isogénie si ils vérifient $\ell^{h-e}x'y'^{-1}=\ell^{h-e}xy^{-1} 
\bmod \ell^{i}$.
Soit $[\ell^{h-e}]([x]P+[y]Q)$ un point de $\ell^i$ torsion engendré par $R$, 
...
$\ell^i$-isogénie.\todo{je regarde un truc plus fort que ce que je veux montrer}
\end{prop}
