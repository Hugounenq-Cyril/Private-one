...
déterminer pour une courbe choisie un nombre premier de Elkies dans 
l'intervalle $[1,L]$ pour $L \in O(\log(q))$.
\begin{lem}
\label{lem:cou:dec}
...
résolution problème du "Calcul de l'isogénie explicite" en terme de $r$ et $q$.
