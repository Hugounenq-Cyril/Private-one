...
être utilisé en peite caractéristique. Ce dernier a
...
en le degré de l'isogénie, celui-ci n'est pas utilisé en pratique à cause d'une
dépendance polynomiale en la caractéristique $p$ qui le rend trop coûteux dès 
que la caractéristique augmente. Ainsi l'algorithme de Lercier et Sirvent 
\cite{Lercier-Sirvent2008} avec une dépendance logarithmique en $p$ est 
préféré pour les plus grandes caractéristiques. Ces deux algorithmes, n'étant 
pas limités par la caractéristique, on ne connaît pas exactement, dans le cas 
de la moyenne caractéristique, quand il est pertinent d'utiliser l'algorithme
de Lercier et Sirvent~\cite{Lercier-Sirvent2008} à la place de celui de 
Couveignes~\cite{Couveignes96}. De plus comme dans SEA 
d'autres opérations ont un coût plus élevé que l'algorithme de Lercier et Sirvent 
...
de corps finis \cite{Couveignes00, DeFeo-Schost'12}
...
travaux de Miret et al. \cite{MiretMRV05}  \cite{MiretMSTV06} 
...
Voyons maintenant quelques utilisations ou améliorations possibles des 
résultats présentés dans cette thèse.

L'amélioration l'algorithme de Couveignes que nous proposons
