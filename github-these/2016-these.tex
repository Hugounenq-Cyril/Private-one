...
moyenne, dés lors il n'est pas évident dans ce cas lequel utiliser. De plus 
comme dans SEA d'autres opérations, notamment le calcul 
...
plus efficace n'est donc pas motivée dans ce contexte. 
...
Cependant le calcul d'isogénies peut avoir un intérêt 
...
courbes sous une représentation spécifique.
...
base. Ce travail de Couveignes a été amélioré par la suite par De Feo 
\cite{DeFeo11}, qui se sert notamment d'une construction efficace de tours 
d'extensions de degré $p$ de corps finis, développée conjointement avec Schost 
\cite{DeFeo-Shost'12} d'après un travail de Couveignes \cite{Couveignes00}. 
...
on se sert de \emph{graphes d'isogénies}.
\todo{C'est le bon moment pour ajouter un dessin.
 Dis au moins ce que sons les sommets et les arêtes.}
Ceux-ci ont été étudiés pour la première fois par \cite{Kohel96} afin de 
calculer l'anneau des endomorphismes d'une courbe elliptique. Fouquet et Morain
\cite{FouquetMorain02} ont par la suite tilisé ces graphes, appelés aussi 
\emph{volcans d'isogénies}, afin d'améliorer SEA. Enfin les travaux de Miret et
...
ceux de De Feo, Doliskani et Shcost \cite{DeFeo-Doliskani-Schost13}, Doliskani 
et Schost \cite{Doliskani-Schost15} et généralisent les résultats qui nous 
intéressent.

Ainsi dans notre travail nous avons montré le résultat suivant:
\begin{thm}
