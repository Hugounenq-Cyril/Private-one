...
\end{thm}
 ...
 \item Pour $d_0 = 1$ on a $\mathsf{F}_0 \equiv \mathbb{F}_{q}$ et l'on cherche un non-résidu $\ell$-adique de la même manière que la méthode préconisée dans le cas $\d_0 \neq 1$.
