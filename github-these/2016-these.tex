...
\subsection{\'Etude de la rationalité de la $\ell^{k}$-torsion dans une tour d'extensions $\ell$-adique ou Calculs de directions dans le volcan de $\ell$-isogénies.}
...
coefficients dans $\mathbb{Z}/\ell^{h-e+i} \mathbb{Z}$ un second point $Q$ tel 
que l'action du Frobenius exprimée dans la base $(P,Q)$ soit de la même forme 
que $M$.
...
\end{prop}
\todo{Traiter de façon uniforme les volcans (non)-réguliers}
\begin{proof}
