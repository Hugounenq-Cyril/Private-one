...
est préféré pour les plus grandes caractéristiques. En pratique déterminer 
lequel des deux est le plus pertinent doit se faire au cas par cas. 

Bien que la compléxité de SEA ne soit pas dominée par le calcul de l'isogénie 
explicite,
...
trappe de Teske~\cite{Teske06}, 
les travaux de cryptanalyse de 
...
\cite{Pizer90,Pizer95,Kohel96} afin de calculer l'anneau des endomorphismes d'une courbe 
...
Kohel a cherché à déterminer le niveau d'une courbe dans le graphe tout en 
connaissant la cardinalité de celle-ci afin de déterminer son anneau des 
endomorphismes. Fouquet et Morain \cite{FouquetMorain02} ont par la suite 
...
\emph{volcans d'isogénies}. Ensuite les travaux de Miret \textit{et al.} 
\cite{MiretMRV05}  \cite{MiretMSTV06} \todo{Verifier que les 3 citations sont pertinentes}
