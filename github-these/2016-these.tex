...
a une complexité trop grande. Une amélioration l'algorithme que nous proposons
...
pourrait aboutir quand on aura des meilleures représentations de compositum 
...
\cite{BissonSutherland11}, où l'on connaît déjà une factorisation de $d_{\pi}$,
avec les propositions ~\ref{pro:mat:fro} ou \ref{pro:mat:fro:atk}, selon le cas
Elkies ou Atkin, on connaîtrait la valuation $\ell_i$ adique du 
...
pour calculer un polynôme de Hilbert. En effet dans l'algorithme de Bröker, il 
...
Dans l'algorithme de Sutherland \cite{Sutherland11a} pour le calcul de polynôme
...
l'algorithme de marche utilisé dans le volcan similaire aux travaux de 
...
Dans l'algorithme BLS (Bröker Lauter Sutherland) \cite{BLS12} pour 
...
définis sur $\mathbb{F}_p$ pour les courbes en bas du volcan. On pourrait à 
