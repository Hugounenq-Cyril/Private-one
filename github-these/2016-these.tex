...
Dans la tour d'extensions $\ell$-adiques les éléments de la tour peuvent aussi être représentés comme des éléments à coefficients dans $\mathsf{F}_0$, or un élément peut aussi être représenté .
