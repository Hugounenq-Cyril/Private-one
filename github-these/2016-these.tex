...
de degré $\ell^{\alpha}$, \todo{justifier} et cela contredirait la structure du volcan des 
...
la même manière qu'à la définition~\ref{def:alp:bet}. \todo{Oups plus du tout vrai} % représentant la plus grande 
