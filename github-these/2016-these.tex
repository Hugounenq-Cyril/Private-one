...
$\ell^{h} < \sqrt{r}$. Pour trouver un nombre de premier de Elkies qui vérifie 
...
nombre premier testé est valide pour appliquer 
l'algorithme~\ref{alg:cou:ell-adique}.
Ainsi en bornant $\ell$ par $\log(q)$ dans la complexité obtenue à la 
proposition~\ref{pro:full-complexity} on obtient un résultat qui majore la 
complexité obtenue pour la recherche et validation d'un nombre premier de 
Elkies pour l'algorithme~\ref{alg:cou:ell-adique}, cette complexité nous donne 
le résultat. 
\end{proof}
