...
$\ell^{h-e}x'y'^{-1}=\ell^{h-e}xy^{-1} \bmod \ell^{i}$.
...
x'y'^{-1}\bmod \ell^{i}$. On voit donc que seul compte les valeurs de 
$\ell^{h-e}x$ et $\ell^{h-e}y$ modulo $\ell^i$ pour la détermination de la 
$\ell^i$-isogénie.
