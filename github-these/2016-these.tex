...
lors les endomorphismes de la courbe(dont le Frobenius) exprimés dans cet ordre
ne peuvent s'exprimer qu'à l'aide de ces deux matrices et on ne peut alors 
avoir le coefficient triangulaire supérieur de valuation différente de  
$\min (h, v_\ell(a))$.
\end{proof}
...
\begin{defi}[Bases horizontales et diagonales]
  ...
  si $\pi$ est diagonale dans cette base, \emph{horizontale} si 
