...
Soient $P,R,R'$ trois points de la courbe elliptique $E$ située au cratère 
...
%\in (\mathbb{Z}/\ell^i\mathbb{Z})^{\times}$
 alors $R$ et $R'$ engendrent la même $\ell^i$-isogénie.
\end{prop}
...
compte la valeur de $x\ell^{h}$ et $y\ell^{h} \bmod \ell^{i}$ par le 
...
engendrent deux $\ell^i$-isogénies distinctes n'ont pas la même matrice par la 
proposition~\ref{pro:atk:inv:mat} alors par un argument de cardinalité 
on a chaque matrice à classe de conjugaison près par $\left( 
...
E[\ell^{h+i}]$ alors $\pi(P+\gamma \ell^{i}R,R)=\pi(P,R)$.
