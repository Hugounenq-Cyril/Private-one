...
\subsection{D\'ecomposition de la $\ell^{h+i}$ torsion sous l'action du Frobenius ou \'Etude de la rationalité de la $\ell^{k}$-torsion dans une tour d'extensions $\ell$-adique}
