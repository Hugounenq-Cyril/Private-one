...
\todo{Regarder les notations pour le corps de base/extensions...}
...
on note~$V(i,c)$ l'image dans $\mathbb{Z}/\ell^k \mathbb{Z}$ donnée par~$f(k-1-i,c,– )$:
then la structure multiplicative de $V(i, c)$
...
Moreover, les orbites de~$W(i,j,c,d)$ correspondent de façon bijective
...
on peut se ramener à la condition $\lambda \equiv \mu \equiv 1 \bmod 4$.
