...
\begin{tikzpicture}[scale=0.60,domain=-10/3:4.5,samples=100,yscale=1/2]
          ...
          \draw (U0) node{$\mathbb{U}_{v_E(p)}$};
          \draw (U1) node{$\mathbb{U}_{v_E(p)+1}$};
          \draw (U3) node{$\mathbb{U}_{v_E(p)+i}$};
          ...
          \draw (P1) node{$\bullet$};
          \draw (P2) node{$\bullet$};
          \draw (P3) node[color=gray!50]{$\bullet$};
