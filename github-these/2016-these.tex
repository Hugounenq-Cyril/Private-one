...
Par définition de ~$k$, on a ~$\ell^{2k+1} \in O(r\ell^2)$.
  ...
  \log(r))$ opérations auquel il faut ajouter le coût de calcul du polynôme de 
  $r$-division  de $r\mathsf{M}(r^2)\log(r)\log(r q)$. Tous ces coûts sont dominés par
  celui du calcul de~$A_{a,b}$.  Enfin, en moyenne 
