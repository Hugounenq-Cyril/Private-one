...
\begin{cor}
\label{cor:mon:atk}
Soit $E$ située au niveau $h-e < h$ d'un volcan des $\ell$-isogénies avec 
...
courbe elliptique $E$ située sur au niveau $h-e$ du volcan de $\ell$-isogénies,
...
\todo{Dire quelque part que l'on travaille avec des volcans de hauteur h>0}
...
volcan des $\ell$-isogénies de hauteur $h>0$. On note~$d_1$ le degré de la plus 
...
On obtient donc le résultat en utilisant le fait que~$a \cdot d = q \bmod \ell$. 
\end{proof}
...
\label{pro:atk:d1}
Soit $E$ une courbe elliptique ordinaire située sur le cratère d'un 
volcan des $\ell$-isogénies de hauteur $h>0$, avec $\ell$ un nombre premier 
de Atkin,
\begin{itemize}
...
Dorénavant on va garder cette notation de $\beta$ qui est définie comme la plus
grande valuation $\ell$-adique rationnelle de la courbe sur le cratère du 
volcan des $\ell$-isogénies défini sur $\mathbb{F}$. \todo{Faire un peu mieux}
...
\todo{moche à modifier, encore moche ?}
 \begin{equation*}
 \begin{alignedat}{1}
