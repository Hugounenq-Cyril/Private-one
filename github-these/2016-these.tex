...
Le calcul d'isogénies apparaît dans SEA et a donc un intérêt central. 
...
Sirvent~\cite{Lercier-Sirvent2008}, il n'est pas utilisé en pratique à 
...
En pratique déterminer lequel des deux est le plus pertinent doit se faire au cas par cas. \todo{reflexion sur cela}
...
Bien que la compléxité de SEA ne soit pas dominée par le calcul de l'isogénie explicite
...
contextes. %que l'algorithme SEA, 
Le calcul d'isogénies est intéressant par exemple pour les crypto-système à 
...
\cite{Pizer90,Prizer95,Kohel96} afin de calculer l'anneau des endomorphismes d'une courbe 
