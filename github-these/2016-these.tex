...
On a donc bien une correspondance entre les points définis à l'aide du Théorème
 ...
 $\mathsf{Gal}(\mathbb{F}_q:\mathbb{F}_q)$ sur un polynôme à coefficients dans
 $\mathbb{F}_q)$,
 \item savoir l'action afin de calculer les représentants de l'action de 
 $\mathsf{Gal}(\mathbb{F}_q:\mathbb{F}_q)$.
 \end{itemize}
