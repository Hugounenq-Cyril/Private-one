...
est meilleure que l'algorithme~%\ref{alg:
cependant l'algorithme travaille dans des extensions de corps plus petites.
...
complètes pour le Frobenius, dès lors on ne travaillerait pas avec les autres 
abscisses.  
