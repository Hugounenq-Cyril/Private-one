...
courbe située au niveau du cratère. On a donc représenté la matrice à l'endroit
correspondant dans le volcan du codomaine de la $\ell^{i}$-isogénie engendrée 
par le second vecteur de la base de $E[\ell^{h+i}]$ dans laquelle est calculée 
l'action du Frobenius. Ainsi les courbes dans le volcan atteintes
...
$2$-isogénie et donc une seule matrice par conjugaison (voir 
proposition~\ref{pro:atk:equi}). Pour le niveau de la base du volcan il est à 
