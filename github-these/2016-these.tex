...
\todo{Dire que l'on peut se passer de l'étude pour les courbes en-dessous du 
cratère car on sait monter dans le volcan...}
...
\section{Calcul des directions dans le volcan de $\ell$-isogénies}
\label{cha:con:poi}
...
\subsubsection{Décomposition de la $\ell^k$ torsion sous l'action du Frobenius}
\label{sub:classes}
...
\subsubsection{Décomposition de la $\ell^{h+i}$ torsion sous l'action du Frobenius}
