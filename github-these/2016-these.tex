...
\[
\pi(P,Q')=\left ( \begin{matrix}a & b\ell^{h} \\ c\ell^{h} & d
\end{matrix}\right ) 
\]
avec $Q'=[x']P+[y']Q$. De plus tous les points qui forment des matrices 
...
$\beta \in \left( \mathbb{Z}/\ell^i\mathbb{Z}\right)^{\times}$. On voir alors 
