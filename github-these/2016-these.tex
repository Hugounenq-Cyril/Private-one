...
diagonale de la $\ell^k$-torsion et donc pourquoi il faut travailler avec des
bases horizontales.
...
Sur la figure~\ref{fig:ex:con:dia} on voit un exemple de mises 
en correspondance de bases diagonales de la $3^3$-torsion. On voit en 
particulier que cela ne permet une correspondance exacte que pour la 
...
$\ell^{k-h}$-isogénie-horizontale, dès lors on ne sait dire à partir de cette 
information si les isogénies de degré supérieur à $3$ engendrées par le point 
diagonal sont du même type et repectent l'action de la $r$-isogénie $\phi$. En
effet pour le choix d'un de ces points diagonaux on peut choisir comme sur l'exemple un point horizontal pour la direction $\color{red} \lambda$ pour la courbe $E_s$ et un point non horizontal pour la direction $ \color{red} \lambda$ sur la courbe $E'_s$.  Dès lors on a pas une correspondance de sous-groupes cycliques et l'on doit considérer les cominaisons linéaire avec le second point de la base diagonale de direction $\color{blue} \mu$ pour les correspondances induites par la $r$-isogénie. peuvent être horizontaux et respecter l'action de la 
$r$-isogénie ou bien ne pas être horizontaux et du coup ne pas respecter 
celle-ci. \todo{préciser et faire référence, cela est vu en annexe}
