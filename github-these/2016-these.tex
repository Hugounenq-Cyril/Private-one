...
Ainsi si l'on représente à l'aide d'un arbre binaire le calcul de $T_0$, on a sur la figure en rouge, les seuls éléments utilisés lors du calcul de $T_0$, cela ne représente donc d'une branche de celui-ci.
