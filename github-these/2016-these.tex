...
Maintenant que la courbe isogène est entièrement déterminée, il reste à déterminer le noyau de l'isogénie de celle-ci à l'aide d'algorithmes tels que \cite{BMSS08}  puis \cite{Lercier-Sirvent2008}  cherchent à résoudre ce problème dansun tel contexte. Un présentation de ces algorithmes est faite \textcolor{red}{ref à mettre plus tard}.
