...
\mathsf{M}(\ell^2)\log(\ell)\log(\ell q))$ par la 
proposition~\ref{pro:alg:diagonal}, en appliquant les résultats de 
...
avec une complexité de $O()$ opérations sur $\mathbb{F}_q$.
