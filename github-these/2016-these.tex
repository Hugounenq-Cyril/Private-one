...
%O\Bigl( (r \ell + \log(\ell q) ) \mathsf{M}(r \ell^4) \log(r) \log(\ell) +  r\ell \mathsf{M}(r \ell^{1,5}) \log(r)^2 \Bigr) 
 ...
 \[
O\Bigl(\sqrt{r}\mathsf{M}(\sqrt{r}\ell^{1,5})\log(r)\log(\ell)\log(\ell q) + r \ell ( \mathsf{M}(r)\log(r)+ \mathsf{M}(r \ell^4) \log(r) \log(\ell) + \mathsf{M}(r \ell^3) \log(r)^2 \log(\ell) )  \Bigr)
 \]
\end{prop}
\begin{proof}
...
r \ell ( \mathsf{M}(r)\log(r)+ \mathsf{M}(r \log(q)^4) \log(r) \log(\log(q)) + \mathsf{M}(r \log(q)^3) \log(r)^2 \log(\log(q)) + \log(q)^6 )  &\Bigr)&
