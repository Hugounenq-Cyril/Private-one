...
Cependant comme on a vu précédemment le coût de calcul des $T_i$ est de $\Omega(\mathsf{M}(t_j)(t_j)^{(\omega-1)/2}\max_i(\ell_i))$ on majore donc le cout total par $\Omega(\mathsf{M}(t)(t_j)^{(\omega-1)/2}\max_i(\ell_i))$ par superlinéarité de $\mathsf{M}$
