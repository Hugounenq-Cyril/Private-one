...
Une fois que l'on a calculé les polynômes Q et T selon les différentes possibilités données par le scindement de $\phi_\ell$ dans $\mathbb{F}_q$, alors on peut énoncer de manière unifiée comment sont calculés les relèvement et les descentes dans la tour d'extension $\ell$-adique.
