...
\begin{prop}
Soit $E$ une courbe elliptique définie sur $\mathbb{F}_q$ telle que $E(\mathbb{F}_q)[\ell^{\infty}]=\mathbb{Z}/n_1\mathbb{Z} \times \mathbb{Z}/n_2\mathbb{Z}$ alors si:
\begin{itemize}
\item[$v_{\ell}(n_1)>v_{\ell}(n_2)$] alors $E$ est à un niveau bien défini
\item[$v_{\ell}(n_1)=v_{\ell}(n_2)$] alors $E$ n'est pas à un niveau bien défini
\end{itemize}
\end{prop}
...
\begin{cor}
On a alors le passage de niveau qui entraine des changements de structure...
\end{cor}
