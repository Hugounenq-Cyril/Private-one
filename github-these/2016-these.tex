...
Les nombres premiers de Elkies sont les plus favorables au calcul de $t_{\pi}$ car une fois que l'on a un nombre premier de Elkies alors par le théorème \ref{thm:Atkin} il existe un sous groupe cyclique $C$ de la $\ell$ torsion qui est un espace propre pour le Frobenius $\pi$, on résoud alors l'équation suivante dans ce groupe
\begin{equation*}
...
\subsubsection{Elkies' case} \label{sub:Elkies}
