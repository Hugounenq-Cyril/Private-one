...
On présente donc dans le premier chapitre des notions de bases, notamments les
courbes elliptiques et les endomorphismes de courbes elliptiques et tout 
particulièrement le Frobenius. Dans le 
...
par De Feo \cite{DeFeo11}. Dans le chapitre 3, dans la suite des travaux de 
\cite{Doliskani-Schost15}, nous présentons les tours $\ell$-adiques sur 
lesquelles on va travailler par la suite. Nous établissons notamment un 
...
volcan et la structure des $\ell$ sous-groupes de Sylow, pour cela on utilise
...
Ensuite nous étudions dans le chapitre 5 la forme de l'action du Frobenius sur 
...
chapitre des algorithmes pour calculer des points générateurs de certaines 
isogénies, spécifiées par leurs directions, dans le volcan. 

Ensuite nous présentons dans le chapitre 6, l'intérêt de ces directions dans
l'algorithme de Couveignes $\ell$-adique et son application dans l'algorithme 
de Couveignes. Nous présentons et analysons donc un algorithme $\ell$-adique de
...
Couveignes $\ell$-adique et étudions leurs pertinences. 
...
de cela pour obtenir des résultats sur la multiplication scalaire tel que dans \todo{Citer Christophe Negre}.

Enfin on pourrait utiliser le résultat de la proposition %~\ref{pro:cla:fro:mat} pour faire un crypto système dans lequel le point P fixe serait la clé maitre secrète partagée entre deux utilisateurs et on utiliserait alors les formes des matrices pour communiquer la clé correspondant au point que l'on doit utiliser. Ce crypto système semble cependant un peu trop couteux pour être pratique.


 
\todo{Probleme biblio reférence double}
\bibliography{Biblio}
