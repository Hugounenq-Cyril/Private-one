...
Le calcul d'isogénies, morphismes de groupe de noyau fini entre deux courbes
elliptiques apparaît dans SEA et a donc un intérêt particulier. En effet deux 
courbes elliptiques reliées par une isogénie ont la même cardinalité.

L'intérêt de tels algorithmes se justifie par leur utilisation dans l'algorithme
...
$\mathbb{F}_q$ de caractéristique $p$ suffisamment grande. Ce travail a été 
ensuite amélioré par les travaux de Bostan Morain Salvy et Schost \cite{BMSS08}
puis par ceux de Lercier Sirvent \cite{Lercier-Sirvent2008} qui a permis 
d'utiliser cette méthode sans contrainte de caractéristique, ce dernier 
...
Soient deux $j$-invariants $j_0$ et $j_1$ et un entier positif $r$. Si les 
...
$j(E_a)=j_0$ et $j(E_b)=j_1$, alors le problème du calcul explicite d'isogénie est
de calculer les courbes $E$, $E'$ telles que $j(E)=j_0$ et $j(E')=j_1$, et 
