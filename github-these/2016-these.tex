...
Frobenius sur un groupe de $\ell$-torsion. Ceci est fait en déterminant 
...
\cite{Elkies91}  et Atkin \cite{Atkin88}, celles-ci permettent notamment de 
travailler avec des sous-groupes de la $\ell$-torsion lorsque le Frobenius 
admet deux espaces propres (cas Elkies).

Ainsi au cours de l'algorithme de Schoof
