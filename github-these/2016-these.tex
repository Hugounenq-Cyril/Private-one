...
travailler avec les deux groupes de points isomorphes:
\begin{itemize}
...
Sachant que l'on répète les étapes~\ref{alg:mult-ell:ord}, 
~\ref{alg:mult-ell:int} et \ref{alg:mult-ell:Cauchy}  $O(r)$fois cela donne la 
complexité.
\end{proof}
