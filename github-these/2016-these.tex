...
elliptiques apparaît dans SEA et a donc un intérêt central. En effet deux 
...
algorithmes sur les corps finis ont été développés \cite{Couveignes94}, 
...
moyenne, dès lors il n'est pas évident lequel utiliser. De plus comme dans SEA 
...
\cite{DeFeo11}, qui, d'après un travail de Couveignes \cite{Couveignes00}, se 
sert notamment d'une construction efficace de tours d'extensions de degré $p$ 
de corps finis, développée conjointement avec Schost \cite{DeFeo-Shost'12}. 
...
afin principalement de s'affranchir de la dépendance polynomiale en $p$. Pour 
cela, nous devons en particulier déterminer des ensembles de points préservés par 
l'action de l'isogénie que nous voulons calculer, tout en se servant d'une construction 
...
Sur la Figure~\ref{fig:int:vol} nous pouvons en voir un exemple. Sur ce graphe 
...
Pour arriver à ce résultat nous avons dévelopé de nouvelles méthodes, sans 
