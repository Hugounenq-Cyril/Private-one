...
Ainsi, la matrice du Frobenius sur $\mathbb{Z}_{\ell}$ est  
\begin{itemize}
...
problème du «Calcul explicite de l'isogénie» en un temps espéré de 
 \begin{equation*}
 \begin{alignedat}{1}
...
$\ell^{k-h}$ fois celles-ci ont une complexité de 
