...
\end{figure}
On remarquera que pour le calcul d'une racine carrée on a un coût attendu, cela est dû à une partie de l'algorithme qui est de type non déterministe (Las Vegas).
