...
\end{equation*} 
de telle sorte que l'on ait $\eta=1+\lambda+\lambda \varepsilon_{n-2}$, ainsi en définissant $\zeta_m=\lambda^{q+q^2+\cdots+q^{m}} $ on a une relation de récurrence pour le calcul de $\varepsilon$:
