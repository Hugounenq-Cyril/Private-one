...
du théorème des restes chinois elliptique appliqué à des points $P_i,Q_i$ d'ordre 
$\ell_i^{k_i}$, avec $r, \ell_i$ tous premiers entre eux, (partiellement) horizontaux de directions $\lambda_i,\mu_i$ 
