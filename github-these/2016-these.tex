...
\begin{enumerate}
\item soit $[End(E) : End(E')]=\ell$, 
\item soit $[End(E) : End(E')]=1$,
\item soit $[End(E') : End(E)]=\ell$.
\end{enumerate}
\end{lem}
...
\begin{enumerate}
\item montante si $[End(E') : End(E)]=\ell$,
\item descendante si $[End(E) : End(E')]=\ell$,
\item horizontale si $[End(E') : End(E)]=1$.
\end{enumerate}
\end{defi}
...
\begin{proof}
Voir \cite[Lemme 6.1.1]{Fouquet01}
\end{proof}
...
\item Si $\ell \mid [\mathcal{O} : \mathbb{Z}[\pi]]$ et $\ell \nmid [\mathcal{O}_K : \mathcal{O}]$ alors $E$ admet $\ell-\left( \frac{d_K}{l} \right)$ isogénies descendantes
