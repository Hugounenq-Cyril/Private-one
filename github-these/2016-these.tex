...
\begin{prop}
Soit $E$ une courbe elliptique $\ell$ un nombre premier de Elkies de On a $h$
\end{prop}

 $h$ représente ici la hauteur du volcan de $\ell$-isogénies défini sur $\mathbb{F}_q$, on rappelle que l'on a $h=\frac{v_{\ell}(d_{\pi})-v_{\ell}(d_K)}{2}$ (voir section \ref{sec:ann:end}).
