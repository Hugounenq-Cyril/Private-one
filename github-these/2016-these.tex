...
la caractéristique $p$ qui le rend trop couteux dés que la caractéristique 
...
Sur la Figure~\ref{fig:int:vol} on voit un graphe d'isogénies. Sur ce graphe 
...
isogénies de même degré. En particulier toutes les courbes d'un même graphe
...
de changer de déterminer un changement de niveau dans le volcan d'isogénies 
sous certaines conditions. Tous ces travaux ayant pour but d'améliorer ceux de 
...
Frobenius sur la $\ell^k$-torsion d'une courbe elliptique. On étend la 
définition de direction d'isogénie dans le volcan, déjà définie pour le 
changement de niveau dans le volcan \cite{FouquetMorain02}, à l'aide du 
Frobenius dans le cas Atkin. Nous présentons aussi dans ce chapitre des 
algorithmes permettant de calculer des points qui engendrent le noyau de 
...
algorithmes de Couveignes $\ell$-adique présenté dans le 
chapitre~\ref{cha:alg:fin}  afin de voir notamment si l'on ne peut pas 
travailler avec un seul groupe cyclique des points d'ordre $\ell^k$ ou avec 
différents nombres de Elkies et étudions leur intérêt. 
