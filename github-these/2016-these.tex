...
d'avoir $*y \wedge \ell =1$ pour avoir une $\ell^{h+i}$-isogénie descendante. \todo{Vraiment ?} 
...
valeur de $\ell^{h}b^{-1}y^{-1}* \bmod \ell^{h-e+i}$, ainsi en faisant 
...
l'action du Frobenius ne permet de distinguer les isogénies descendantes entre
elles.
