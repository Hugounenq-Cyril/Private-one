...
information pour déterminer l'isogénie. Cet algorithme
a toutefois le désavantage d'avoir une dépendance exponentielle en $p$.
Ce travail de Couveignes fût amélioré par la suite par De Feo  \cite{DeFeo11},
qui se sert notamment d'une construction efficace d'extensions $p$-adiques de 
corps finis faite conjointement avec Schost \cite{DeFeo-Shost'12}. 
...
en un temps quasi quadratique avec une dépendance polynomiale en la caractéristique du corps.
\end{thm}
