...
Ainsi à l'aide de cette méthode et des points (1) et (2) de la proposition \ref{pro:par:iso} pour deux courbes $E$, $E'$ $r$-isogènes avec $r$ premier avec $\ell$ de tels points $\psi(P) et E$ et $\psi(P') et E'$ tels que 
