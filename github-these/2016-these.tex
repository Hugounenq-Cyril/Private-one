...
Faire la généralisation aux courbes en dessous du cratère. \todo{Faire aussi cela}

Par la proposition~\ref{prop:parallel}, la profondeur de ~$E$ et $E'$ sous
leur cratère respectif est la même.  Par la
proposition~\ref{prop:parallel}~\ref{prop:parallel:ascent}, les
courbes sommets~$E_{\max}$ et~$E'_{\max}$ sont encore $r$-isogèness; on utilise
