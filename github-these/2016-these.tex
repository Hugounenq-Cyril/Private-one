...
\section{Complexite}
Dans ce document on va utiliser la notation classique $O$ pour mesurer la 
...
\`A l'aide des méthodes de \cite{SchonhageStrassen71} et de leurs généralisations  \cite{Schonhage77} \cite{Cantor-Kaltofen91} , une complexité de $O(n\log(n) \log \log (n))$ pour multiplier des polynômes de degré $n$ à coefficients dans un anneau $R$ quelconque est atteinte.
