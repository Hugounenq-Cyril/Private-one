...
\begin{prop}
Soit $P \in E[\ell^k]$ un vecteur propre de $\pi$, $i\leqslant k$ tel que $[\ell^i]P$ soit horizontal, $\psi:E \mapsto E_i$ une isogénie descendante de degré $\ell^i$, on note $P'=\psi(P)$, alors $[\ell^{k-i}]P'$ est un générateur du noyau d'une isogénie montante de degré $\ell^{i}$ noté $\widehat{\psi}$ et l'on a $\widehat{\psi}(P')$ qui est le générateur d'une isogénie horizontale de degré $\ell^{k-i}$.  
\end{prop}

\begin{proof}
Comme $\psi$ est une isogénie descendante de degré $\ell^i$ et que $P$ est un vecteur propre de $\pi$ alors $P \not \in \ker \psi$, ainsi $P$ et $\psi(P)$ sont de même ordre. De plus comme l'isogénie  
\'A rédiger...
\end{proof}

\begin{prop}
Soit $P \in E[\ell^k]$, tel que $[\ell]P$ soit horizontal, $\psi:E \mapsto E_1$ une isogénie descendante de degré $\ell$, on note $P'=\psi(P)$, alors $\ell^{k-1}P'$ est un générateur du noyau d'une isogénie montante de degré $\ell^1$ noté $\widehat{\psi}$ et l'on a $\widehat{\psi}(P')$ qui est le générateur d'une isogénie horizontale de degré $\ell^{k-1}$.  
\end{prop}
