...
\end{figure}
\begin{figure}
\subfloat[Image d'origine]{\label{fig:edge-a}\includegraphics[scale=0.8]{benchmarks/graphe-101-2^18bis.pdf} }
  \hspace{10pt}
\subfloat[Après une détection des contours de Laplace]{	\begin{tikzpicture}[scale=0.10]
\coordinate (A) at (0,2);
\coordinate (B) at (0,6);
\coordinate (C) at (0,10);
\draw (A) node[left]{
