...
$p^{k-1}(p-1) > 4 \ell +1$ est suffisant, asymptotiquement le résultat reste le 
même.
\end{rem}
...
$A$ étant censé représenter l'action d'une isogénie sur les points d'ordre 
$p^k$ alors $A$, comme l'isogénie, doit commuter avec le Frobenius et être 
défini sur $\mathbb{F}_q$. Couveignes \cite{Couveignes96} ne tirait pas 
...
représentant de l'orbite défini dans $\mathbb{U}_k \setminus \mathbb{U}_{k-1}$ 
...
$\mathbb{U}_k \setminus \mathbb{U}_{k-1}$ (on s'est placé dans le cas où 
$\mathbb{L}_k = \mathbb{U}_k$), et sont donc tous dans des orbites de tailles 
identiques.
...
Ainsi on s'est placé dans le cas où $\mathbb{L}_1 \not \cong \mathbb{F}_q$  et 
$\mathbb{L}_2 \not \cong \mathbb{L}_1$ qui correspond au pire des cas en 
pratique. \todo{déjà dit} Pour plus de détails sur la description des orbites selon les cas 
...
\begin{thm}
Soient $E$ et $E'$ deux courbes $\ell$-isogènes, l'algorithme de Couveignes a une complexité de:
\[
