...
\begin{algorithm}
\caption{\label{alg:TRC:init}Lemme pour Théorème des restes chinois sur une courbe elliptique }
\begin{algorithmic}[1]
...
\FOR{$i=1$ à $n$}
\STATE $Q$ sortie de l'algorithme~\ref{alg:TRC:init} généralisé tel que $\ell_i^{k_i}Q=0$ et $[\overset{n}{\underset{j \neq i}{\underset{j = 0}{\prod}}}\ell_j^{k_j}]Q=P_i$;
...
Un exemple de l'algorithme~\ref{alg:TRC:init} généralisé est disponible en 
annexe \todo{faire algorithme + référence}.
...
\todo{trouver un meilleur nom pour cet algorithme}
\begin{algorithm}
\caption{\label{alg:TRC:init}Lemme pour Théorème des restes chinois généralisé sur une courbe elliptique }
\begin{algorithmic}[1]
...
\ENSURE $P$ un point de $E$ d'ordre $\prod_{i=1}^n \ell_i^{k_i}$  tel que $[\overset{n}{\underset{i \neq i_0}{\underset{i = 0}{\prod}}}\ell_i^{k_i} ]P=P_{i_0}$ et $[\ell_i^{k_i}]P=0_E$ pour $i \in [1,n] i \neq i_0$.
\STATE $P \leftarrow P_{i_0}$;
% \STATE Calcul $(P_1,Q_1)$, a basis of $E[\ell]$
\FOR{$i=0$ à $n$ $i \neq i_0$}
\STATE \label{alg:TRC:init:div} Calcul de $P'=\mathsf{divise}(P,\ell_i^{k_i})$;
\STATE \label{alg:TRC:init:mul} Calcul de $Q=[\ell_{i_0}^{k_{i_0}}]P'$ un point d'ordre $\overset{i}{\underset{i \neq i_0}{\underset{j = 0}{\prod}}}\ell_j^{k_j}$;
\STATE \label{alg:TRC:init:prim} Calcul de $R$ la pré-image de $Q$ d'ordre $\overset{i}{\underset{i \neq i_0}{\underset{j = 0}{\prod}}}\ell_j^{k_j}$ par $[\ell_{i_0}^{k_{i_0}}]$;
