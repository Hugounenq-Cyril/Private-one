...
\begin{thm}
Soient $E$ et $\tilde{E}$ deux courbes elliptiques $\ell$-isogènes définies sur $\mathbb{K}$ de caractéristique nulle ou avec $p>2\ell-1$ alors l'algorithme de Elkies calcule la $\ell$-isogénie en $O(\ell^2)$ opérations sur $\mathbb{K}$.
\end{thm}
