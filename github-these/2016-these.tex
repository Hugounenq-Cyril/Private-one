...
Soient $R,R'$ deux points d'ordre $\ell^{h+i}$ de $E$ située au niveau du 
cratère du volcan de $\ell$-isogénies, alors si l'on a $\pi^x(R)=R'$ alors
$[\ell^i]R$ et $[\ell^i]R'$ engendrent la même $\ell^h$-isogénie.
\end{prop} 

\begin{proof}
A partir de $\pi^x(R)=R'$ on a $[\ell^{i}]\pi^x(R)=\pi^x([\ell^i]R)=[\ell^i]R'$
or l'action du Frobenius sur les points de $\ell^h$-torsion est diagonale ainsi
...
\begin{prop}
Soit $E$ une courbe située au niveau du cratère d'un volcan de $\ell$-isogénies
alors il existe $\ell^{h-1}(\ell+1)$ représentants d'orbites distinctes de la 
$\ell^{h+i}$-torsion.
\end{prop}
...
une base $(P,Q)$ de la $\ell^{h+i}$-torsion, on cherche tous les points de la
forme $[a]P+[b]Q$ tels que les points $[\ell^i]([a]P+[b]Q)$ engendrent des 
$\ell^h$-isogénies distinctes. On a alors $\ell^{h-1}(\ell+1)$ représentants 
