...
la caractéristique $p$ qui le rend trop couteux dés lors que la 
...
moyenne, dés lors il n'est pas évident lequel utiliser. De plus comme dans SEA 
d'autres opérations, notamment le calcul d'équations de Weierstrass 
...
Sur la Figure~\ref{fig:int:vol} on voit un graphe, sur celui-ci 
sont représentés à l'aide de points les courbes elliptiques définies à 
isomorphisme près, celles-ci sont reliées par des traits symbolisant les 
isogénies de même degré. En particulier toutes les courbes d'un même volcan 
...
\cite{FouquetMorain02} ont par la suite utilisé ces graphes, appelés aussi 
...
de changer de niveau dans le volcan d'isogénies sous certaines conditions. Tous ces 
travaux ayant pour but d'améliorer ceux de Fouquet et Morain 
\cite{FouquetMorain02} ils ont aussi amélioré SEA.
...
et Schost \cite{Doliskani-Schost15}, et en donnent quelques généralisations utiles.
...
Pour arriver à ce résultat nous avons donné de nouveaux moyens, sans 
restrictions, pour définir et déterminer des directions dans les volcans de 
$\ell$-isogénies.

\paragraph{Organisation de la thèse}
Nous présentons donc dans le premier chapitre des notions de bases, notamment 
sur les courbes elliptiques et leurs endomorphismes, et tout particulièrement 
l'endomorphisme de Frobenius. 

Dans le deuxième chapitre nous abordons les différents algorithmes de calculs 
...
$\ell$-adiques. Nous établissons notamment un résultat similaire à celui de De 
Feo \cite{DeFeo11} pour le calcul de polynômes d'interpolation. 

Dans le chapitre 4 nous rappelons les résultats principaux sur les volcans 
...
Ensuite nous étudions dans le chapitre 5 l'action de l'endomorphisme de 
Frobenius sur la $\ell^k$-torsion d'une courbe elliptique. on étend la définition de direction à l'aide
 du Frobenius et ses liens avec les directions dans le volcan de 
...
par leur directions peuvent être utilisées dans un algorithme de Couveignes
ou l'on interpole l'action de l'isogénie sur les points d'ordre $\ell^k$. Nous
appellerons cette variante de l'algorithme de Couveignes: $\ell$-adique.
...
bonnes propriétés nous est fourni d'avance), puis dans le cas général, où l'on 
utilise notamment un résultat de Shparlinski et Sutherland 
\cite{ShparlinskiSutherland14} afin de donner une borne sur l'entier $\ell$. 
On fait aussi une présentation d'une variante qui n'impose pas de contraintes 
...
avec un seul groupe cyclique ou avec différents nombres de Elkies et étudions 
leur intérêt. 
