...
situent pas forcément sur le cratère. 
...
horizontaux $R_{\lambda}, R_{\mu}$ (avec les notations du paragraphe précédent)
...
\label{sub:classes}
On va maintenant voir la décomposition de la $\ell^k$-torsion en orbites selon 
l'action du Frobenius, afin de pouvoir ultérieurement calculer toute la 
