...
plus $\beta=h$ si et seulement si le volcan est \emph{régulier}.
\end{prop}
...
\begin{proof}
Ces résultats viennent du fait que'avec une extension $\ell$-adique on augmente
seulement de $1$ la hauteur du volcan.
\end{proof}
