...
X^2-t_{\pi}X+q=0
\end{equation*}
Cette équation est alors résolue modulo la $\ell_i$-torsion, avec $\ell_i$ un nombre premier. Cette résolution est donc répétée pour un ensemble de nombres premiers $L$ tel que: $\Pi_{\ell_i \in L}\ell_i>4 \sqrt{q}$.
