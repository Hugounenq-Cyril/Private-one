...
\subsubsection{Améliorations de De Feo}
...
\begin{lem}
Le coût de calcul de la $p^k$-torsion est de au moins $\Omega(\ell^2)$ opérations sur $\mathbb{F}_q$.
\end{lem}
