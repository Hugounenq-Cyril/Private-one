...
$\mathsf{F}_{\prod_{i=1}^n \ell_i^{k_i}}$ une extension de corps de 
$\mathbb{F}_q$ de degré $\prod_{i=1}^n \ell_i^{k_i}$.
\end{nota}
 ...
 l'interolation à l'aide de l'action de groupe de Galois, le cas où l'on a
 ...
 composita afin de les utiliser pour le TRC Ellipique, or le plongement dans un
 composita a un coût de $O()$ \todo{trouver complexité}. Le coût de résolutions 
 de polynômes de degré $d$ dans une composita de taille $XXX$ est de $O()$ \todo{trouver 
