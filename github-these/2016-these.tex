...
$j$-invariant qui les définit à isomorphisme près. Nous formulons donc le problème
...
la caractéristique $p$ qui le rend trop coûteux dès que la caractéristique 
...
changement de niveau dans le volcan par \cite{FouquetMorain02}, à l'aide du 
