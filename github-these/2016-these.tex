...
\end{equation}
avec $a_1,a_2,a_3,a_4,a_6$ des éléments de $\overline{\mathbb{K}}$ et $(X:Y:Z) 
\in \mathbb{P}^2(\overline{\mathbb{K}})$. Dès lors que $a_1,a_2,a_3,a_4,a_6$ 
appartiennent à $\mathbb{K}$ alors la courbe est dite définie sur $\mathbb{K}$.
\end{defi}
