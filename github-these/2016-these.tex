...
\end{tikzpicture}
\end{center}
\caption{ \label{fig:poi:hor} Exemples de  différents points diagonaux $P \in E_s$ d'ordre $2^3$ tels que $\pi(P)=[\color{blue}{\mu}\color{black}]P$, ici sont représentées les différentes isogénies de noyau $\langle P \rangle$}
\end{figure}
Sur le schéma~\ref{fig:poi:hor} sont représentés les isogénies qui ont pour 
