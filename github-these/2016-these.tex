...
\begin{proof}
En utilisant donc les méthodes préconisées par les travaux de Gunji et Voloch, il y a tout d'abord le coût de calcul de la $p$-torsion. Majoré 

Blabla
\end{proof}

\paragraph{Interpolation de Cauchy} L'interpolation de Cauchy se fait en deux étapes: tout d'abord il faut calculer un polynôme d'interpolation $A$ d'après la donnée de valeurs prises en les points de $p^k$-torsion. Ensuite on doit reconstruire à l'aide de l'algorithme d'Euclide une fraction rationnelle $\frac{R}{V}$ égale à $A$ modulo la $p^k$ torsion. 
