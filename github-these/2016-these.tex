...
\begin{equation*}
R=[a]P+[b]Q \rightarrow R'=[xa]P+[yb]Q
\end{equation*}
...
\]
Comme  $\pi(P)=[\lambda]P$, on obtient: 
\[
\pi([a]  P + [b]  Q)= [a \lambda]  P + [b] \pi(Q)
\]
...
\begin{eqnarray*}
\pi( [xa] P + [yb] Q) &=& [xa] \pi (P) + [ yb] \pi (Q) \\
&=&  [xa \lambda ] P + [y]([b] \pi (Q)) 
\end{eqnarray*}
Ainsi en remplaçant  $[b]\pi (Q)$ on obtient: 
\begin{eqnarray*}
\pi( [xa] P + [yb] Q) &=& [xa \lambda ] P + [y] ( [a(\mu -\lambda) + \beta \ell^h]  P + [\mu b] Q) \\
&=& [xa\lambda + y a (\mu - \lambda)+ y \beta \ell^h ] P + [y \mu b ] Q
\end{eqnarray*}
Or comme on suppose que $\pi(P,R)=\pi(P,R')$ on obtient:
\begin{eqnarray*}
\pi( [xa] P + [yb] Q) &=&  [\beta \ell^h] \cdot P + [\mu] ([xa] P + [yb] Q ) \\
&=& [xa\lambda + y a (\mu - \lambda)+ y \beta \ell^h ] P + [y \mu b ] Q
\end{eqnarray*}
Ainsi on doit avoir 
\[
(* + b' \cdot b^{-1} \cdot (\alpha + a \cdot (q-1))  =( \alpha + q \cdot * ) \cdot P_2 \bmod \ell^{h+i}
\]
Ainsi comme $P_2$ est un point d'ordre $l^k$ pour avoir l'égalité on doit avoir: 
\[ \alpha + q \cdot * \equiv  * + b' \cdot b^{-1} \cdot ( \alpha  + a \cdot (q-1))) \bmod l^h\]
Ce qui nous amène à l'équation: 
\[ \alpha \cdot (1-b' \cdot b^{-1}) \equiv (* - b' \cdot b^{-1} \cdot a ) \cdot (1-q)  \bmod l^h \]
\end{proof}
\printnomenclature
