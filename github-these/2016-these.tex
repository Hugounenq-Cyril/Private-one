...
\begin{proof}
Comme vu précédemment \todo{préciser les références} toute $\ell^i$-isogénie engendrée par $R'$ est déterminée par la valeur de $\ell^{h}b^{-1}y^{-1}*$, on rappelle que l'on est obligé d'avoir $y \wedge \ell =1$ pour avoir une $\ell^{h+i}$-isogénie descendante. 
\end{proof}
\printnomenclature
