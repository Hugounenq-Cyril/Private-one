...
de son amélioration (S.E.A) \cite{Schoof95} due aux travaux de Atkin \cite{Atkin88} et 
...
$\Phi_r$. Ce travaille de Couveignes fût amélioré par la suite par De Feo  \cite{DeFeo11},  qui se sert notamment
d'une construction efficace d'extensions $p$-adiques de corps finis faite conjointement avec Schost \cite{DeFeo-Shost'12}. 
...
d'endomorphismes d'une courbe elliptique. Fouquet et Morain ont par la suite 
...
la structure des $\ell$ sous groupe de Sylow.
Les travaux de \cite{Ionica-Joux10} ont permis eux, à l'aide de couplage de 
points, de déterminer la direction d'isogénies dans le volcan sous certaines
conditions. 
...
chapitre des algorithmes pour calculer des points générateurs de certaines \todo{Qu'est-ce qu'un point générateur?}
