...
Pour un sous-groupe $C$ de $E(\mathbb{K})$ les formules de Vélu \textcolor{red}{Citer Velu} \cite{velu1971} permettent d'exprimer de façon canonique une isogénie séparable $E \Rightarrow E'$ de noyau $C$ et son codomaine $E'$.  L'isogénie est $\mathbb{F}_q$-rationnelle si et seulement si le polynôme qui s'annule sur les abscisses des points du noyau $C$ est défini dans $\mathbb{K}[X]$.
