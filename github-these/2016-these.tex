...
\begin{prop} 
\label{pro:iso:mon}
Soit $E$ une courbe elliptique définie sur $\mathbb{F}_q$ telle que l'on ait sa $\ell$-torsion infinie de la forme: $E(\mathbb{F}_q)[\ell^{\infty}]=\nicefrac{\mathbb{Z}}{\ell^{r}\mathbb{Z}} \times \nicefrac{\mathbb{Z}}{\ell^{s}\mathbb{Z}}= \langle P,Q \rangle $ avec $r>s +1 \geqslant  1$ et $P$ un point d'ordre $n_1$. Alors on a:
\begin{enumerate}
\item La $l$-isogénie engendrée par $\ell^{r-1}P$ est une isogénie montante qui mène à une courbe elliptique $E'$ ayant comme structure de $l$-torsion: \[E'(\mathbb{F}_q)[\ell^{\infty}]=\nicefrac{\mathbb{Z}}{\ell^{r-1}\mathbb{Z}} \times \nicefrac{\mathbb{Z}}{\ell^{s+1}\mathbb{Z}} \]
...
Soit une courbe elliptique $E$ définie sur $\mathbb{F}_q$ telle que l'on ait $E(\mathbb{F}_{q})[\ell^{\infty}]=\mathbb{Z} / \ell^{r} \mathbb{Z} \times \mathbb{Z} / \ell^{s} \mathbb{Z}$, alors on a $E(\mathbb{F}_{q^{\ell}})[l^{\infty}]=\mathbb{Z} / \ell^{r+1} \mathbb{Z} \times \mathbb{Z} / \ell^{s+1} \mathbb{Z}$.
\end{cor}
